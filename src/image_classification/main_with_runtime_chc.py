...
def main():
    ...
    assert args.spectrain == True
    logging.info('Running old version spectrain (chc)')
    ...
    if args.spectrain:
        if args.log_dir != None:
            args.log_dir += '_spectrain_chc'
        logging.info('Using spectrain_chc')
        assert args.macrobatch == False
...
def train(train_loader, r, optimizer, epoch):
    ...
    logging.info(f'optim_name = {optimizer.optim_name}')
