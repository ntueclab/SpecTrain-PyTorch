...
parser.add_argument('--macrobatch',
                    action='store_true',
                    help='Macrobatch updates to save memory')
parser.add_argument('--spectrain', action='store_true', help='Spectrain')
parser.add_argument('--square', action='store_true', help='s ** 2')
parser.add_argument('--find_median', action='store_true')

parser.add_argument('--world_size', type=str, help='world_size', default=os.getenv('SLURM_NTASKS'))
...
def main():
    ...
    logging.warning(f'master addr: {args.master_addr}, rank:{args.rank}, local_rank:{args.local_rank}')
