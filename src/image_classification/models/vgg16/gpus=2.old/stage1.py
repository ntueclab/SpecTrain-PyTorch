...
class Stage1(torch.nn.Module):
    def __init__(self):
        ...
        self.layer27 = torch.nn.Linear(in_features=512, out_features=10, bias=True)
        ...
        #self.layer29 = torch.nn.Linear(in_features=512, out_features=512, bias=True)
        ...
        #self.layer32 = torch.nn.Linear(in_features=512, out_features=10, bias=True)
